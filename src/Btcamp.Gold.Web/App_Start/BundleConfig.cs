...
namespace Btcamp.Gold.Web
{
    public class BundleConfig
    {
        ...
        {
            bundles.Add(new StyleBundle("~/css").IncludeDirectory("~/content/css", "*.min.css"));
            bundles.Add(new StyleBundle("~/css/messenger").Include(
                "~/Content/css/messenger/messenger.css",
                "~/Content/css/messenger/messenger-theme-flat.css"
                ));
            ...
            bundles.Add(new ScriptBundle("~/scripts/messenger").Include(
                "~/Scripts/plugin/messenger/bootbox.min.js",
                "~/Scripts/plugin/messenger/messenger.min.js",
                "~/Scripts/plugin/messenger/messenger-theme-flat.js",
                "~/Scripts/common.js"));
